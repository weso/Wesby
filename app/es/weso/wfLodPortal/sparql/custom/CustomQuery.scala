...
trait CustomQuery {
  ...
  protected def handleResource[T](dataStore: Model, prefix: String, suffix: String, method: RdfResource => T): List[T] = {
    handleResource[T](dataStore, prefix, suffix, method)
  }

  protected def handleResource[T](dataStore: InverseModel, prefix: String, suffix: String, method: RdfResource => T): List[T] = {
    handleResource[T](dataStore, prefix, suffix, method)
  }

  protected def handleResource[T, U](dataStore: DataStore, prefix: String, suffix: String, method: RdfResource => T): List[T] = {
  ...
  protected def handleLiteral[T](dataStore: Model, prefix: String, suffix: String, method: RdfLiteral => T): List[T] = {
    handleLiteral[T](dataStore, prefix, suffix, method)
  }

  protected def handleLiteral[T](dataStore: InverseModel, prefix: String, suffix: String, method: RdfLiteral => T): List[T] = {
    handleLiteral[T](dataStore, prefix, suffix, method)
  }
  ...
  protected def loadLabel(r: RdfResource) = {
    "Undefined Label"
  }
}